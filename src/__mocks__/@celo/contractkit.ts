  ...
  return {
    ...
    contracts: {
      ...
      getReserve: async () => ({
        ...
        getAssetAllocationSymbols: jest.fn(async () => [
          "cGLD",
          "BTC",
          "ETH",
          "DAI",
      ...
      getGoldToken: async () => ({
        balanceOf: jest.fn(
          async () => new mockBigNumber("1.16644499691333039665549272e+26"),
        ),
      }),
      getStableToken: async () => ({
        totalSupply: jest.fn(
          async () => new mockBigNumber("4.1557073455407045025690923e+25"),
        ),
      }),
    },
  };
